...
<main class="mainproducto">
    <section class="compra">
        <div class="contenedor1">
            <div class="imagen">
                <img src="{{asset('assets/img/tiendacarros/718boxter.jpg')}}" alt="">
                <div class="text-relacionado"><h2>producto relacionado</h2></div>
                <div class="relacionado-producto">
                    <div class="relacionado1"><a href="/911ca"><img src="{{asset('assets/img/tiendacarros/911carreraa.jpg')}}" alt=""></a></div>
                    <div class="relacionado2"><a href="/718cay"><img src="{{asset('assets/img/tiendacarros/718caymann.jpg')}}" alt=""></a></div>
                </div>
            </div>
            <div class="texto">
                <div class="nombre-producto"><h2>porshe 718boxter</h2></div>
                <div class="precio-producto"><h2>$10.000.000 cop</h2></div>
