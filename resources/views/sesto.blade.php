...
<main class="mainproducto">
    <section class="compra">
        <div class="contenedor1">
            <div class="imagen">
                <img src="{{asset('assets/img/productos/lambosesto.png')}}" alt="">
                <div class="text-relacionado"><h2>producto relacionado</h2></div>
                <div class="relacionado-producto">
                    <div class="relacionado1"><a href="/revuelto"><img src="{{asset('assets/img/productos/lamborevuelto.png')}}" alt=""></a></div>
                    <div class="relacionado2"><a href="/urus"><img src="{{asset('assets/img/productos/urus.png')}}" alt=""></a></div>
                </div>
            </div>
            <div class="texto">
                <div class="nombre-producto"><h2>lamborghini sesto</h2></div>
                <div class="precio-producto"><h2>$200.000.000 cop</h2></div>
