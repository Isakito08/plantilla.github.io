...
<main class="mainproducto">
    <section class="compra">
        <div class="contenedor1">
            <div class="imagen">
                <img src="{{asset('assets/img/productos/spider.png')}}" alt="">
                <div class="text-relacionado"><h2>producto relacionado</h2></div>
                <div class="relacionado-producto">
                    <div class="relacionado1"><a href="/purosangue"><img src="{{asset('assets/img/productos/purosangue.png')}}" alt=""></a></div>
                    <div class="relacionado2"><a href="/portofino"><img src="{{asset('assets/img/productos/portofino.png')}}" alt=""></a></div>
                </div>
            </div>
            <div class="texto">
                <div class="nombre-producto"><h2>Ferrari SF90spider</h2></div>
                <div class="precio-producto"><h2>$450.000.000 cop</h2></div>
