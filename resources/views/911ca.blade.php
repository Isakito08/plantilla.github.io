...
<main class="mainproducto">
    <section class="compra">
        <div class="contenedor1">
            <div class="imagen">
                <img src="{{asset('assets/img/tiendacarros/911carreraa.jpg')}}" alt="">
            ...
            <div class="texto">
                <div class="nombre-producto"><h2>porshe 911carrera</h2></div>
                <div class="precio-producto"><h2>$15.000.000 cop</h2></div>
