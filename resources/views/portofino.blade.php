...
<main class="mainproducto">
    <section class="compra">
        <div class="contenedor1">
            <div class="imagen">
                <img src="{{asset('assets/img/productos/portofino.png')}}" alt="">
            ...
            <div class="texto">
                <div class="nombre-producto"><h2>Ferrari portofino</h2></div>
                <div class="precio-producto"><h2>$150.000.000 cop</h2></div>
